...
import { FaBriefcase, FaBuilding, FaClipboardCheck, FaEnvelopeOpenText } from 'react-icons/fa';
...
function Home() {
  ...
  const quickActions = [
    {
      title: 'Students',
      description: 'Browse students by year, branch, and placement profile.',
      to: '/tpo/students',
    ...
    {
      title: 'Post Job',
      description: 'Publish a new placement opportunity.',
      to: '/tpo/post-job',
      icon: <FaBriefcase />,
    ...
    {
      title: 'Companies',
      description: 'Manage recruiter and company records.',
      to: '/tpo/companys',
      icon: <FaBuilding />,
    ...
    {
      title: 'Send Notice',
      description: 'Share placement updates with users.',
      to: '/tpo/send-notice',
