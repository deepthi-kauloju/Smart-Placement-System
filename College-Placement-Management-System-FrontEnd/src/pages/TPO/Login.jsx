      ...
      <div className="auth-shell flex justify-center items-center px-4">
        <button type="button" className="auth-back" onClick={() => navigate('/')}>
          ...
          <div className='flex justify-center items-center flex-col'>
            ...
            <h1 className="auth-title h3 mb-1 font-weight-normal">TPO Log In</h1>
            <p className="auth-subtext text-center mb-3">Manage students, jobs, companies, and placement notices.</p>
          </div>
          <div className="w-full">
            <label htmlFor="inputEmail" className="sr-only">Email address</label>
            <input type="email" id="inputEmail" className="auth-input form-control ml-1" placeholder="Email address" autoFocus autoComplete='email' name='email' value={email} onChange={handleChange} />
          ...
          <div className="w-full">
            <div className="relative flex justify-center items-center w-full">
              ...
              <input type={isEyeOpen ? 'text' : 'password'} id="inputPassword" className="auth-input form-control auth-password-input" placeholder="Password" autoComplete='current-password' name='password' value={password} onChange={handleChange} />
          ...
          <span className='auth-subtext text-center'>Log In as Management?
            <span className='auth-link cursor-pointer px-1' onClick={() => navigate('../management/login')}>
              Click Here
            </span>
          </span>
          <p className="auth-copyright text-center">© College Placement Management System 2025 - 26</p>
        </form>
      </div>
    </>
  );
