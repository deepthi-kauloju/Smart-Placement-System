      ...
      <div className="auth-shell flex justify-center items-center px-4">
        <button type="button" className="auth-back" onClick={() => navigate('/')}>
          ...
          <div className='flex justify-center items-center flex-col'>
            ...
            <h1 className="auth-title h3 mb-1 font-weight-normal">Management Log In</h1>
            <p className="auth-subtext text-center mb-3">Oversee placement activity, approvals, and communication.</p>
          </div>
          ...
          <span className='auth-subtext text-center'>Log In as TPO?
            <span className='auth-link cursor-pointer px-1' onClick={() => navigate('../tpo/login')}>
              Click Here
            </span>
          </span>
