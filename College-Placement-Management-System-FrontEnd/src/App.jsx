...
function Layout({ header }) {
  ...
  return (
    <>
      <div className="dashboard-shell flex flex-col min-h-screen">
        <Navbar isSidebarVisible={isSidebarVisible} toggleSidebar={toggleSidebar} />
        <div className="flex flex-grow">
          <Sidebar isSidebarVisible={isSidebarVisible} />
          <div className={`dashboard-content content flex-grow p-4 md:p-6 transition-all duration-300 ${isSidebarVisible ? 'md:ml-64' : 'ml-0'}`}>
        ...
        <Suspense fallback={<LoadingComponent />}>
          <Routes>
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['superuser']} /></UserProvider>}>
              ...
              {/* all notice */}
              <Route element={<Layout header="All Notices" />}>
                <Route path="/admin/all-notice" element={<ViewAllNotice />} />
              </Route>
              {/* view notice */}
              <Route element={<Layout header="Notice" />}>
                <Route path="/admin/notice/:noticeId" element={<ViewNotice />} />
              </Route>
              {/* send notice */}
              <Route element={<Layout header="Send Notice" />}>
                <Route path="/admin/send-notice" element={<SendNotice />} />
              </Route>
