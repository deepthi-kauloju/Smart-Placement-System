          ...
          <>
            ...
            <div className=''>
              <form onSubmit={handleSubmit}>
                <div className="my-4 grid grid-cols-2 gap-5 text-base max-sm:text-sm">
                  {/* basic info  */}
                  <div className="dashboard-card grid rounded-2xl p-6 max-md:col-span-2">
                    <p className="dashboard-kicker">Profile</p>
                    <span className='mt-1 text-2xl font-extrabold text-slate-950 max-sm:text-xl'>Basic Details</span>
                        ...
                        <div className="space-y-4">
...

                          {
                            userData?.studentProfile?.uin && (
                              <div>
                                <span className="font-bold text-slate-600">UIN: </span>
                                <span className="text-slate-800">
                                  {userData?.studentProfile?.uin}
                                </span>
                              </div>
                          ...
                          (userData?.studentProfile?.resume?.filepath !== "undefined") && (
                            <div className="py-2 px-2">
                              <span className='bg-blue-500 py-1 pr-2 rounded cursor-pointer hover:bg-blue-700'>
                                <a href={FILE_BASE_URL + userData?.studentProfile?.resume?.filepath} target='_blanck' className='no-underline text-white'>
                  ...
                  {/* college info  */}
                  <div className="dashboard-card rounded-2xl p-6 max-md:col-span-2">
                    <p className="dashboard-kicker">Academics</p>
                    <span className='mt-1 block text-2xl font-extrabold text-slate-950 max-sm:text-xl'>College Information</span>
                    <div className="grid grid-cols-2">
                      {/* semester sgpa  */}
                  ...
                  {/* past qualification  */}
                  <div className="dashboard-card col-span-2 rounded-2xl p-6">
                    <p className="dashboard-kicker">Education History</p>
                    <span className='mt-1 block text-2xl font-extrabold text-slate-950 max-sm:text-xl'>Past Qualification</span>
                ...
                <div className="flex flex-col items-center gap-2">
                  <Button className="auth-submit rounded-full px-6 py-3 text-sm font-bold" variant="primary" type='submit'>
