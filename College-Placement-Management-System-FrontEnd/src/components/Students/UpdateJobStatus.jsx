          ...
          <>
            <div className="my-4 grid grid-cols-2 gap-5 text-base max-sm:grid-cols-1 max-sm:text-sm">
              <div className="flex flex-col gap-2">
                <div className="">
                  {/* Basic Details  */}
                  <Accordion defaultActiveKey={['0']} alwaysOpen className='dashboard-accordion w-full'>
                          ...
                          <div className="flex flex-col justify-between py-2">
                            ...
                            <div className="flex justify-between">
                              <div className="space-y-4">
                                ...
                                <div>
                                  <span className="dashboard-info-label">Number: </span>
                                  <span className="dashboard-info-value">
                                    {currentUser?.number}
                                  </span>
                                </div>

                                {
                                  currentUser?.uin && (
                                    <div>
                                      <span className="dashboard-info-label">UIN: </span>
                                      <span className="dashboard-info-value">
                                        {currentUser?.uin}
                                      </span>
                                    </div>
                                ...
                                <div>
                                  <span className="dashboard-info-label">Company Name: </span>
                                  <span className="dashboard-info-value">
                                    {company?.companyName}
                                  </span>
                                </div>
                                <div>
                                  <span className="dashboard-info-label">Job Title: </span>
                                  <span className="dashboard-info-value">
                                    {data?.jobTitle}
                                  </span>
                                </div>
              ...
              <div className="">
                {/* Job details  */}
                <Accordion defaultActiveKey={['1']} alwaysOpen className='dashboard-accordion w-full'>
                    ...
                    <Accordion.Body>
                      <div className="">
                          ...
                          <div className="flex flex-col gap-2 justify-center items-center">
                            ...
                            <UploadOfferLetter jobId={jobId} fetchJobDetailsOfApplicant={fetchJobDetailsOfApplicant} />
                            {
                              ...
                              <div className="cursor-pointer w-fit flex gap-1 justify-between items-center">
                                <span
                                  className='dashboard-pill bg-blue-100 text-blue-700 transition hover:bg-blue-200'
                                  onMouseEnter={() => setEyeIsHover(true)}
                                  onMouseLeave={() => setEyeIsHover(false)}
                                >
                                  <a
                                    className='flex items-center justify-center text-blue-700 no-underline'
                                    target="_blanck"
                                    href={FILE_BASE_URL + applicant?.offerLetter}
                                  >
                                    {
                                      eyeIsHover ? (
                                ...
                                {/* delete offer letter  */}
                                <span
                                  className='dashboard-pill cursor-pointer bg-red-100 text-red-700 transition-all duration-200 hover:bg-red-200'
                        ...
                        <div className="mb-2 mt-3">
                          <Button className="auth-submit rounded-full px-5 py-3 text-sm font-bold" variant="primary" onClick={handleSubmit}>
