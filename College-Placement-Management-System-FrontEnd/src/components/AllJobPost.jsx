      ...
      <div>
        {
          loading || !currentUser ? (
            ...
            <div className="dashboard-card overflow-x-auto rounded-2xl p-3 max-sm:text-sm md:p-5">
              <div className="table-scrollbar">
                <Table hover className='dashboard-table mb-0 min-w-[880px] bg-white text-sm'>
                  <thead>
                    <tr>
                      <th>Sr. No.</th>
                            ...
                            <td>
                              <div className="flex justify-around items-center">
                                <div className="px-0.5">
                                  ...
                                  >
                                    <i
                                      className="fa-solid fa-circle-info cursor-pointer text-xl text-slate-400 transition-colors duration-200 ease-in-out hover:text-blue-600 max-sm:text-lg"
                                      onClick={() => {
                                        const rolePaths = {
                                  ...
                                  currentUser.role !== 'student' && (
                                    <>
                                      ...
                                      <div className="px-0.5">
                                        ...
                                        >
                                          <i
                                            className="fa-regular fa-pen-to-square cursor-pointer text-xl text-slate-400 transition-colors duration-200 ease-in-out hover:text-green-600 hover:fa-solid max-sm:text-lg"
                                            onClick={() => {
                                              const rolePaths = {
                                      ...
                                      <div className="px-0.5">
                                        ...
                                        >
                                          <i
                                            className="fa-regular fa-trash-can cursor-pointer text-xl text-slate-400 transition-colors duration-200 ease-in-out hover:text-red-600 hover:fa-solid max-sm:text-lg"
