        ...
        loading ? (
          ...
          <>
            ...
            <div className="my-8 grid grid-cols-2 gap-4 text-base max-sm:text-sm max-md:grid-cols-1">
              <div className="dashboard-card h-fit rounded-2xl p-6 max-md:p-3">
                <p className="dashboard-kicker">Profile</p>
                <h3 className="dashboard-section-title mb-4 mt-1 text-2xl max-md:text-xl">Personal Details</h3>
                <div className="grid grid-cols-2 max-md:grid-cols-1">
                  ...
                  <div className="flex flex-col justify-start items-end max-md:items-center max-md:mt-1">
                    ...
                    <Col xs={6} md={9} className=" flex justify-end rounded">
                      <Image src={FILE_BASE_URL + userData?.profile} thumbnail />
                    </Col>
                    {
                      (userData?.studentProfile?.resume?.filepath !== "undefined" && userData?.role === 'student') && (
                        <div className="py-2 px-2  max-sm:text-sm">
                          <span className='dashboard-pill bg-blue-100 text-blue-700'>
                            <a href={FILE_BASE_URL + userData?.studentProfile?.resume?.filepath} target='_blanck' className='no-underline text-blue-700'>
...

              {
                userData?.role === "student" && (
                  <>
                    {/* placement status  */}
                    <div className={`dashboard-card h-fit rounded-2xl p-6 ${placement?.isPlaced === true ? 'bg-green-50' : 'bg-red-50'} max-md:p-3`}>
                      <div className=''>
                        <p className="dashboard-kicker">Placement</p>
                        <h3 className="dashboard-section-title mb-4 mt-1 text-2xl max-md:text-xl">Placement Status</h3>
                                  ...
                                  <Accordion flush className='flex flex-col gap-4'>
                                    <Accordion.Item eventKey={'0'} className='shadow-md'>
                                      ...
                                      <Accordion.Body>
                                        ...
                                        <Table hover size='sm' className="dashboard-table mb-0 min-w-[760px] bg-white text-sm">
                                          <thead>
                                            <tr>
                                              <th style={{ width: "5%" }}>#</th>
                                          ...
                                          <tbody>
                                            {
                                              userData?.studentProfile?.appliedJobs?.length > 0 ? (
                                                ...
                                                <tr>
                                                  <td colSpan={7} className="py-8 text-center font-semibold text-slate-500">Not yet applied to any job.</td>
                                                </tr>
                                              )
                                            }
...

              {
                ...
                (userData?.isProfileCompleted === true && userData?.role === 'student') && (
                  <>
                    <div className="dashboard-card rounded-2xl p-6 max-md:p-3">
                      <div className=''>
                        <p className="dashboard-kicker">Academics</p>
                        <h3 className="dashboard-section-title mb-4 mt-1 text-2xl max-md:text-xl">College Information</h3>
...

              {
                (userData?.studentProfile?.pastQualification && userData?.role === 'student') && (
                  <>
                    <div className="dashboard-card h-fit rounded-2xl p-6 max-md:p-3">
                      <div className=''>
                        <p className="dashboard-kicker">Education</p>
                        <h3 className="dashboard-section-title mb-4 mt-1 text-2xl max-md:text-xl">Past Qualification</h3>
              ...
              {/* Internship details  */}
              {
                (userData?.studentProfile?.internships && userData.studentProfile.internships.length !== 0) && (
                  <div className="dashboard-card col-span-2 h-fit rounded-2xl p-6 max-md:col-span-1 max-md:p-3">
                    <div className=''>
                      <div className="flex justify-between">
                        <h3 className="dashboard-section-title mb-4 text-2xl max-md:text-xl">Internship Details</h3>
                        ...
                        <div className=''>
                          ...
                          <Accordion defaultActiveKey={['1']} flush className='flex flex-col gap-4'>
                            <Accordion.Item eventKey={'1'} className='shadow-md'>
                              ...
                              <Accordion.Body>
                                <div className="overflow-x-auto">
                                <Table hover className="dashboard-table mb-0 min-w-[760px] bg-white text-sm">
                                  <thead>
                                    <tr>
                                      <th style={{ width: "5%" }}>#</th>
