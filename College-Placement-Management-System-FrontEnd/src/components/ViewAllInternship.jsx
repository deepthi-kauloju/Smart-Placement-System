              ...
              <Table hover className='dashboard-table mb-0 min-w-[980px] bg-white text-sm'>
                ...
                <tbody>
                  {internships?.length > 0 ? (
                        ...
                        <td>
                          {
                            internship?.companyWebsite ? (
                              <a href={internship?.companyWebsite} target='_blanck' className='dashboard-table-link'>
                                {internship?.companyWebsite}
                              </a>
                            ) : '-'
                          }
                        ...
                        <td>
                          ...
                          <div className="flex justify-around items-center max-lg:flex-col max-lg:gap-1">
                            <div className="px-0.5">
                              ...
                              >
                                <i
                                  className="fa-regular fa-pen-to-square cursor-pointer text-xl text-slate-400 transition-colors duration-200 ease-in-out hover:text-blue-600"
                            ...
                            <div className="px-0.5">
                              ...
                              >
                                <i
                                  className="fa-regular fa-trash-can cursor-pointer text-xl text-slate-400 transition-colors duration-200 ease-in-out hover:text-red-600"
                    ...
                    <tr>
                      <td colSpan="8" className="py-8 text-center font-semibold text-slate-500">Internship not added yet.</td>
                    </tr>
                  )}
                </tbody>
              </Table>
