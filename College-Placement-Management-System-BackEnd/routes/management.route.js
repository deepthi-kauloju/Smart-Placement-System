...
const uploadNoticeAttachment = require('../config/MulterNoticeAttachment');
...
router.post('/send-notice', authenticateToken, uploadNoticeAttachment.single('attachment'), SendNotice);
