...
router.post('/upload-resume', authenticateToken, uploadResume.single('resume'), UploadResume);

// Route to upload offer letter
router.post('/upload-offer-letter', authenticateToken, uploadOfferLetter.single('offerLetter'), UploadOfferLetter);
